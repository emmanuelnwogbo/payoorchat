  ...
  _processRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(messageId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          io = (0, _socketInit.getIO)();
          _context.next = 4;
          return _message["default"].findOne({
            _id: messageId
          });
        case 4:
          messageItem = _context.sent;
          if (messageItem) {
            _context.next = 8;
            break;
          }
        ...
        case 8:
          user = messageItem.user, isUser = messageItem.isUser, content = messageItem.content, timestamp = messageItem.timestamp;
          _context.next = 11;
        ...
        case 11:
          ...
          console.log(_typeof("".concat(_id)));
          room = "".concat(_id);
        ...
        case 20:
          ...
          console.error('Error in processRequest:', _context.t0);
        case 23:
        case "end":
...
var _default = exports["default"] = processRequest;