    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _message["default"].findById({
            _id: messageId
          });
        case 4:
          ...
          messageObjectId = new _mongoose["default"].Types.ObjectId(messageId);
          _context.next = 10;
          return _user["default"].findByIdAndUpdate(user, {
            $push: {
              unreadMessages: messageObjectId
            }
          }, {
            "new": true,
...
var _default = exports["default"] = trackUnread;