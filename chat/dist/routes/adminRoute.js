...
var _adminAuth = _interopRequireDefault(require("../services/payoor/adminAuth"));
...
adminRoute.post('/admin/create', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, username, password, newAdmin;
...
adminRoute.post('/admin/authenticate', /*#__PURE__*/function () {
...
adminRoute.get('/admin/getusers', _adminAuth["default"], /*#__PURE__*/function () {
...
adminRoute.get('/admin/getuser', _adminAuth["default"], /*#__PURE__*/function () {
...
adminRoute.get('/admin/getconversation', _adminAuth["default"], /*#__PURE__*/function () {
...
adminRoute.post('/admin/message', _adminAuth["default"], /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _req$body3, content, isUser, isAdmin, isLoggedIn, timestamp, userid, user, messageId;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _req$body3 = req.body, content = _req$body3.content, isUser = _req$body3.isUser, isAdmin = _req$body3.isAdmin, isLoggedIn = _req$body3.isLoggedIn, timestamp = _req$body3.timestamp, userid = _req$body3.userid, user = _req$body3.user;
          _context6.next = 4;
        ...
        case 4:
          messageId = _context6.sent;
          (0, _processRequest["default"])(messageId);
          res.status(200).json({
            message: "Message sent to ".concat(user.username),
            type: "adminmessage"
          });
          _context6.next = 12;
          break;
