...
var _getConversation = _interopRequireDefault(require("../services/payoor/getConversation"));
var _getPayloadFromToken = _interopRequireDefault(require("../services/payoor/getPayloadFromToken"));
...
var conversationRoute = (0, _express["default"])();
conversationRoute.get('/getconversation', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var jwt, conversation;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          jwt = req.query.jwt;
          _context.next = 3;
          return (0, _getConversation["default"])(jwt);
        case 3:
