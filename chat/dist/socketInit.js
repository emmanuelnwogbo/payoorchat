...
function initSocket(server) {
  ...
  io.use( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(socket, next) {
      var token, adminAuth, _yield$getValidUser, _id;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            token = socket.handshake.auth.token;
            adminAuth = socket.handshake.auth.admin;
            if (token) {
              _context.next = 5;
              break;
            }
          ...
          case 9:
            _context.next = 11;
            return (0, _getValidUser["default"])(token);
          case 11:
  ...
  io.on('connection', function (socket) {
    ...
    console.log(_typeof("".concat(socket.userId)));
    socket.join("".concat(socket.userId));
    ...
    console.log("Socket ".concat(socket.id, " is in rooms:"), socket.rooms);
